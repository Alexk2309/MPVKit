Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/mpv-ios/MPVKit'
  s.license          = { :type => 'GPL-3.0', :text => 'GPL-3.0. See https://www.gnu.org/licenses/gpl-3.0.html' }
  s.author           = { 'mpv-ios' => 'https://github.com/mpv-ios' }
  s.source           = { :http => 'https://github.com/mpv-ios/MPVKit/releases/download/0.41.0-av/MPVKit.xcframework.zip' }
